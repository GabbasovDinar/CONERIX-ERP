 ...
 (function( $ ){
  ...
  $.fn.videoBG.defaults = {
    ...
    $('.video-section').videoBG({
        mp4:'/Ornate_Plus/static/src/img/timelapse.mp4',
        ogv:'/Ornate_Plus/static/src/img/timelapse.ogv',
        webm:'/Ornate_Plus/static/src/img/timelapse.webm',
        poster:'/Ornate_Plus/static/src/img/timelapse.jpg',
        scale:true,
        zIndex:0
    });
